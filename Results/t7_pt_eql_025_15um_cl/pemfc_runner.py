...
i_ext1 = np.linspace(2e-1,1.9,10) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(2.1,2.35,10) # currents near limitting [A/cm^2]
...
t_naf = np.ones(5)*7e-9         # thickness of Nafion shells [m]
...
save_folder = 't7_pt_eql_025_15um_cl' # folder name for saving files
