...
i_ext1 = np.linspace(5e-1,1.9,10) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(2.1,2.45,15) # currents near limitting [A/cm^2]
...
save_folder = 't12_pt_eql_025_ndb_15um_cl' # folder name for saving files
