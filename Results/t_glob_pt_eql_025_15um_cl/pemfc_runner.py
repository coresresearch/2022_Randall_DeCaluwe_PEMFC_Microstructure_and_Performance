...
i_ext1 = np.linspace(5e-1,2.1,15) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(2.20,2.9,20) # currents near limitting [A/cm^2]
...
t_naf = np.array([7,12,7,12,7])*1e-9        # thickness of Nafion shells [m]
...
save_folder = 't_glob_pt_eql_025_15um_cl' # folder name for saving files
