...
i_ext1 = np.linspace(5e-1,1.7,15) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(1.80,2.1,25) # currents near limitting [A/cm^2]
...
save_folder = 't12_pt_lin_025_15um_cl' # folder name for saving files
