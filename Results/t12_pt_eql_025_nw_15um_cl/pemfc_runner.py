...
i_ext1 = np.linspace(5e-1,2.1,20) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(2.2,2.75,40) # currents near limitting [A/cm^2]
...
save_folder = 't12_pt_eql_025_nw_15um_cl' # folder name for saving files
