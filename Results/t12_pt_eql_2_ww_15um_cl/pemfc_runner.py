...
i_ext1 = np.linspace(5e-1,3.5,20) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(3.60,5.5,30) # currents near limitting [A/cm^2]
...
save_folder = 't12_pt_eql_2_ww_15um_cl' # folder name for saving files
