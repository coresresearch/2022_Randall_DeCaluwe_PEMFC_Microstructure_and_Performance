...
sig_meth = 'lit'                # 'lam', 'bulk', 'mix', or 'lit' for sig_io
...
w_Pt = 0.1                     # Pt loading per geometric area [mg/cm^2]
...
data = 'o2'         # include data from Owejan et. al. if (0: off, 1: on)
...
save_folder = 'lit_1_o2'            # folder name for saving files
...
X_BC = 'N2: 0.0,O2: 1.0,H2O: 0.15'   # cathode gas channel composition  [-]
