...
def dsvdt_cl(t, sv, dsvdt, gdl_BC):    
    ...
    for i in range(cl.d['Ny']):                
        ...
        i_Far = sdot_nc_e *ct.faraday
        theta_dot_pt = sdot_nc_pt *cl.d['1/gamma']
        rho_dot_nc_nk = sdot_nc_nk *cl.d['SApv_pt'] *cl.d['1/eps_n'][i]\
                      *ca.naf_b[i].molecular_weights
        ...
        i_dl = (i_io_up - i_io_dwn) *cl.d['1/dy'] - i_Far *cl.d['SApv_pt']
        dsvdt[ca.ptr['phi_dl'] +i*cl.d['nxt_y']] = i_dl *cl.d['1/CA_dl']
