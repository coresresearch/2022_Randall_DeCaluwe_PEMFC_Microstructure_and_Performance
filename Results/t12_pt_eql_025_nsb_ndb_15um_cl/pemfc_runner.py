...
i_ext1 = np.linspace(5e-1,2.1,10) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(2.2,2.45,20) # currents near limitting [A/cm^2]
...
save_folder = 't12_pt_eql_025_nsb_ndb_15um_cl' # folder name for saving files
