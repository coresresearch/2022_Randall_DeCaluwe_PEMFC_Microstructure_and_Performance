...
i_ext2 = np.linspace(2.20,2.7,15) # currents near limitting [A/cm^2]
...
t_cl = 12e-6                    # thickness of cathode CL [m]
...
save_folder = 't12_pt_eql_025_12um_cl' # folder name for saving files
