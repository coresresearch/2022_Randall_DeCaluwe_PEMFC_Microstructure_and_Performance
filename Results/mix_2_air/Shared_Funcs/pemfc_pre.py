...
for i in range(Ny_cl):
    ...
    eps_g_cl[i] = 1 - (SApv_dl *V_s_part/ SA_dl_part)
...
tau_n_cl = eps_n_cl**(-0.5)               # don't use Bruggeman for tau_naf
...
cl.d['D_naf_k'][cl.d['iH_n']] = D_O2_func(cl.d)
cl.d['D_naf_k'][cl.d['iO2_n']] = D_O2_func(cl.d)*1e2
cl.d['D_naf_k'][cl.d['iH2O_n']] = D_O2_func(cl.d)
...
cl.d['flag'] = 1 # turns off update for sig_io
