...
i_ext1 = np.linspace(5e-1,1.7,10) # currents in ohmic region [A/cm^2]
i_ext2 = np.linspace(1.80,2.7,20) # currents near limitting [A/cm^2]
...
save_folder = 't_inc_pt_eql_025_15um_cl' # folder name for saving files
